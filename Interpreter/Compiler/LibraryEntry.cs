...
namespace Interpreter.Compiler
{
    internal class LibraryEntry
    {
        ...
        internal readonly ExpressionType returnType;
        internal readonly ExpressionType[] paramTypes;

        internal readonly string[] references;

        internal readonly string programCode;

        internal LibraryEntry(bool inline, string[] descriptor_and_references, string code)
        {
            this.inline = inline;
