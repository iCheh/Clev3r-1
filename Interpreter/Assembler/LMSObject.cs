...
namespace Interpreter.Assembler
{
    ...
    internal abstract class LMSObject
    {
        ...
        internal LMSObject(string name, int id)
        {
            this.name = name;
            this.id = id;
            this.program = null;
        ...
        internal virtual void StartCode()
        {
            if (program != null)
            {
        ...
        internal void AddOpCode(byte[] opcode)
        {
        ...
        internal void AddConstant(int value)
        {
            AddConstant(value, 0);
        }

        internal void AddConstant(int value, int minimumencodingbytes)
        {
        ...
        internal void AddVariableReference(int index, bool local)
        {
            if (index < 0)
            {
        ...
        internal void AddStringLiteral(string s)
        {
        ...
        internal void AddFloatConstant(double fvalue)
        {
        ...
        internal void AddLabelReference(string label)
        {
        ...
        internal void AddLabelDifference(string descriptor)
        {
        ...
        internal void MemorizeLabel(string label)
        {
            labels[label] = (int)program.Length;
        }

        internal virtual void MemorizeIOParameter(DataType dt, AccessType pt)
        {
            throw new AssemblerException("Can not add IN or OUT data to this object");
        }

        internal virtual void MemorizeStringIOParameter(int size, AccessType pt)
        {
            throw new AssemblerException("Can not add IN or OUT data to this object");
        }

        internal virtual void WriteByteCodes(Stream stream, int offsetToInstructions)
        {
        ...
        internal abstract void WriteHeader(Stream stream);
        internal abstract void WriteBody(Stream stream, int offsetToInstructions);
    ...
    internal class LMSThread : LMSObject
    {
        internal LMSThread(string n, int id) : base(n, id)
        {
        }

        internal override void WriteHeader(Stream stream)
        {
        ...
        internal override void WriteBody(Stream stream, int offsetToInstructions)
        {
    ...
    internal class LMSSubCall : LMSObject
    {
        ...
        internal LMSSubCall(string n, int id) : base(n, id)
        {
        ...
        internal override void StartCode()
        {
        ...
        internal void SetImplementation(LMSSubCall impl)
        {
            if (program != null || implementation != null)
            {
                throw new AssemblerException("Duplicate definition of " + name);
        ...
        override internal void MemorizeIOParameter(DataType dt, AccessType at)
        {
            ioDataTypes.Add(dt);
        ...
        override internal void MemorizeStringIOParameter(int size, AccessType pt)
        {
            if (size < 1 || size > 255)
            {
        ...
        internal void StartCallerMemorization()
        {
            callerMemorization.Add(new List<Object>());
        }

        internal void MemorizeCallerParameter(Object p)
        {
