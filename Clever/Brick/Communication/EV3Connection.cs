...
namespace Clever.Brick.Communication
{
    ...
    public abstract class EV3Connection
    {
        ...
        public byte[] SystemCommand(byte command, BinaryBuffer arguments)
        {
            ...
            messagecounter++;
            //ViewModel.MainWindowVM.Status.Add("0");
            ...
            //ViewModel.MainWindowVM.Status.Add("1");
            SendPacket(packet);
            //ViewModel.MainWindowVM.Status.Add("2");
            for (; ; )
            {
                //ViewModel.MainWindowVM.Status.Add("0");
                ...
                //ViewModel.MainWindowVM.Status.Add("3");
                System.Array.Copy(packet, 4, replyarguments, 0, packet.Length - 4);
                //ViewModel.MainWindowVM.Status.Add("4");
