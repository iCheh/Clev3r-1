    ...
    public class DirectoryEntry
    {
        ...
        public string FileType
        {
            get
            {
                ...
                else if (name.EndsWith(MainWindowVM.ext, StringComparison.InvariantCultureIgnoreCase))
                {
                    return "Basic";
                }
                else if (name.EndsWith(".lmsb", StringComparison.InvariantCultureIgnoreCase))
                {
                    return "Assembler";
                }
        ...
        public bool IsCompileable
        {
            get
            {
                if (!directory)
                {
                    return name.EndsWith(MainWindowVM.ext, StringComparison.InvariantCultureIgnoreCase)
                       || name.EndsWith(".lmsb", StringComparison.InvariantCultureIgnoreCase)
                    ;
                }
                return false;
            }
